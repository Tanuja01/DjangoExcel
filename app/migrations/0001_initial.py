# Generated by Django 3.0.6 on 2020-06-09 12:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gia_can', models.FloatField(blank=True, db_column='gia_CAN', null=True)),
                ('doanh_thu_du_kien', models.FloatField(blank=True, null=True)),
                ('su_co_van_hanh', models.CharField(blank=True, max_length=100, null=True)),
                ('su_kien_bat_thuong', models.CharField(blank=True, max_length=100, null=True)),
